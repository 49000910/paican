...
class OutlookMHTMaster(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle("EDFA 看板管理后台 V27.0")
        self.resize(500, 750)
        layout = QVBoxLayout()
        ...
        self.btn_apply = QPushButton("🚀 立即应用并全屏同步")
    ...
    def init_tray(self):
        ...
        tm = QMenu(); tm.addAction("显示主界面", self.showNormal); tm.addAction("退出", QApplication.instance().quit)
    ...
    def apply_settings(self):
        ...
        self.restyle(); self.add_log("⚙️ 配置同步中..."); self.run_cycle()
    ...
    def process_web(self):
        ...
        mhts = [f for f in os.listdir(d) if f.endswith('.mht')]
        for f in mhts:
                ...
                with open(p_m, 'rb') as fp:
                    ...
                    for part in msg.walk():
                        if part.get_content_type() == "text/html":
                            ...
                            clean_h = f"<style>body{{font-family:sans-serif;padding:20px;font-size:14px;background:#fff;}}</style>" + payload
    ...
    def build_index(self):
        ...
        items_html = ""
        mails_data_html = ""
        for i, f in enumerate(all_files[:100]):
            p = os.path.join(d, f)
            try:
        ...
        <meta http-equiv="refresh" content="{r_sec}">
        <title>{t1}</title><style>
            * {{ margin:0!important; padding:0!important; box-sizing:border-box!important; }}
            ...
            .sb {{ padding:10px; border-bottom:1px solid #eee; }}
            .sb input {{ width:100%; padding:8px; border:1px solid #ddd; border-radius:4px; font-size:12px; outline:none; }}
        ...
        <body><div class="layout">
            <div class="side">
                ...
                <div class="sb"><input placeholder="搜 EP 号或全文关键词..." oninput="doSearch(this.value)"></div>
